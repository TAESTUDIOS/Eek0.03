        ...
        <div className="relative p-5 bg-gradient-to-b from-[#0d2f4d] via-[#123a60] to-[#0b2237] text-white space-y-4">
          <div className="flex justify-center gap-4">
            <div className="relative h-20 w-20">
              <Image src={happyEmoji} alt="Happy emoji" fill sizes="80px" className="object-contain drop-shadow-lg" />
            </div>
            <div className="relative h-20 w-20">
              <Image src={thumbsupHand} alt="Thumbs up" fill sizes="80px" className="object-contain drop-shadow-lg" />
            </div>
          </div>
